 ...
 * @param <T>
 */
public class StringFiletRequest<T> extends Request<String> {
	 ...
	 * @param listener
	 */
	public StringFiletRequest(String url, ErrorListener errorListener,
	 ...
	 * @param listener
	 */
	public StringFiletRequest(int method, String url,
	...
	protected void deliverResponse(String arg0) {
		...
		Result result = null;
		try {
			result = (Result) gson.fromJson(arg0,
					mClazz);
		} catch (Exception e) {
