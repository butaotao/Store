 ...
 */
//@Widget
public class NoEditNumPicker extends LinearLayout {
     ...
     * format().
     */
    private static class TwoDigitFormatter implements NoEditNumPicker.Formatter {
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(NoEditNumPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(NoEditNumPicker view, int scrollState);
    }
     ...
     */
    public NoEditNumPicker(Context context) {
        this(context, null);
    }
     ...
     */
    public NoEditNumPicker(Context context, AttributeSet attrs) {
     ...
     */
    public NoEditNumPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
...
//                            requestFocus();
     ...
     * <p>
     * If the argument is less than the {@link NoEditNumPicker#getMinValue()} and
     * {@link NoEditNumPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link NoEditNumPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link NoEditNumPicker#getMinValue()} and
     * {@link NoEditNumPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link NoEditNumPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link NoEditNumPicker#getMaxValue()} and
     * {@link NoEditNumPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link NoEditNumPicker#getMaxValue()} value.
     * </p>
     * <p>
...
//        }
     ...
     * wrap around the {@link NoEditNumPicker#getMinValue()} and
     * {@link NoEditNumPicker#getMaxValue()} values.
     * <p>
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(NoEditNumPicker.class.getName());
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            NoEditNumPicker.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            NoEditNumPicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
        ...
        public void buttonTapped(int button) {
            ...
            mMode = MODE_TAPPED;
            mManagedButton = button;
            NoEditNumPicker.this.post(this);
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                NoEditNumPicker.this.postDelayed(this,
                ...
                case View.NO_ID: {
                    switch (action) {
                        ...
                        case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                            if (NoEditNumPicker.this.isEnabled()
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (NoEditNumPicker.this.isEnabled() && !mInputText.isFocused()) {
//                                return mInputText.requestFocus();
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NoEditNumPicker.this.isEnabled()) {
                                NoEditNumPicker.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NoEditNumPicker.this.isEnabled()) {
                                ...
                                NoEditNumPicker.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setSource(NoEditNumPicker.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(NoEditNumPicker.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
            ...
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setEnabled(NoEditNumPicker.this.isEnabled());
                event.setSource(NoEditNumPicker.this, virtualViewId);
                requestSendAccessibilityEvent(NoEditNumPicker.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource(NoEditNumPicker.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(NoEditNumPicker.this, virtualViewId);
            info.setParent(NoEditNumPicker.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(NoEditNumPicker.this.isEnabled());
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(NoEditNumPicker.class.getName());
            info.setPackageName(getContext().getPackageName());
            info.setSource(NoEditNumPicker.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(NoEditNumPicker.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(NoEditNumPicker.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(NoEditNumPicker.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
