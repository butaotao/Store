...
public class XRefreshView extends LinearLayout {
	...
	public void setRefreshTime() {
		mHeaderUpdateTextView.setText(format.format(new Date()));
	}
	...
	public XRefreshView(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.refresh);
		if (a.hasValue(R.styleable.refresh_isRefreshWhiteColor)) {
			flag = true;
			init(true);
		} else {
			flag = false;
	...
	private void addHeaderView() {
		try {
			// header view
			mHeaderView = mInflater.inflate(R.layout.refresh_header_1, this,
					false);
			...
			mHeaderProgressBar.setImageResource(R.drawable.loading_animation);
			animationDrawable = (AnimationDrawable) mHeaderProgressBar
					.getDrawable();
	...
	private void addHeaderView(boolean flag) {
		try {
			// header view
			mHeaderView = mInflater.inflate(R.layout.refresh_header_2, this,
					false);
			mHeaderImageView = (ImageView) mHeaderView
					.findViewById(R.id.pull_to_refresh_image);
			mHeaderTextView = (TextView) mHeaderView
			...
			mHeaderProgressBar = (ImageView) mHeaderView
					.findViewById(R.id.pull_to_refresh_progress);
			mHeaderProgressBar
					.setImageResource(R.drawable.loading_animationcolorwhite);
			animationDrawable = (AnimationDrawable) mHeaderProgressBar
					.getDrawable();
			animationDrawable.setOneShot(false);
			// header layout
	 ...
	 */
	private void initContentAdapterView() throws Exception {
	...
	// mFooterTextView.setText("下在加载上周数据");
	// }
	...
	public void onHeaderRefreshComplete() {
		...
		if (!flag) {
			...
			mHeaderImageView.setImageResource(R.drawable.whitefresh);
		}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(XRefreshView view);
	}
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(XRefreshView view);
	}
}
