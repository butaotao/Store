...
public class XRefreshBothView extends LinearLayout {
	...
	public XRefreshBothView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public XRefreshBothView(Context context) {
		super(context);
		init();
	}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(XRefreshBothView view);
	}
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(XRefreshBothView view);
	}
}
