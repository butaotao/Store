...
/**
 * Created by yehj on 2016/3/24.
 */
public class GuideViewPagerAdapter extends PagerAdapter {
    // 界面列表
    private List<View> views;
    private Activity activity;
    private MedicineApplication appContext;
    ...
    public GuideViewPagerAdapter(List<View> views, Activity activity) {
        ...
        appContext = (MedicineApplication) activity.getApplicationContext();
    }
    ...
    public Object instantiateItem(View arg0, int arg1) {
        ...
        if (arg1 == views.size() - 1) {
            TextView mStartButton = (TextView) arg0
