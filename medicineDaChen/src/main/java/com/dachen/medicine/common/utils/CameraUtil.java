...
public final class CameraUtil {
	...
	public static void captureImage(Fragment frgm, Uri outputUri,
			int requestCode) {
		final Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
		intent.putExtra(MediaStore.EXTRA_OUTPUT, outputUri);
		frgm.startActivityForResult(intent, requestCode);
	}
	...
	public static void cropImage(Fragment frgm, Uri originalFileUri,
			Uri outputFileUri, int requestCode, int aspectX, int aspectY,
			int outputX, int outputY) {
		if (originalFileUri == null) {
			return;
	...
	public static void pickImageSimple(Fragment frgm, int requestCode) {
		Intent intent = new Intent(Intent.ACTION_PICK,
				android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
		intent.setType("image/*");
		frgm.startActivityForResult(intent, requestCode);
	...
	// requestCode, int aspectX, int aspectY, int outputX, int outputY) {
