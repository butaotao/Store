...
public final class ChineseHelper {
    ...
    public static char convertToSimplifiedChinese(char c) {
        String simplifiedChinese = CompanyApplication.CHINESE_MAP.get(String.valueOf(c));
    ...
    public static char convertToTraditionalChinese(char c) {
        ...
        for (Map.Entry<String, String> entry : CompanyApplication.CHINESE_MAP.entrySet()) {
    ...
    public static boolean isTraditionalChinese(char c) {
        return CompanyApplication.CHINESE_MAP.containsKey(String.valueOf(c));
    }
