...
//                    iScanningListener.onScanSuccess();
    ...
    private void init() {
        ...
        mPaintScan.setColor(getResources().getColor(R.color.red_fc7d30));
...
//        centerBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.head_icon);
        //设置扫描渲染的shader
        scanShader = new SweepGradient(mWidth / 2, mHeight / 2,
                new int[]{Color.TRANSPARENT, Color.parseColor("#feba91")}, null);
    }
...
//        drawCenterIcon(canvas);
     ...
     * @param canvas
     */
    private void drawCenterIcon(final Canvas canvas) {
