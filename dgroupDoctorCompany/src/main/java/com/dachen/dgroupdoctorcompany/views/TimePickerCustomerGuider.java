 ...
 *
 */
public class TimePickerCustomerGuider extends LinearLayout {
	 ...
	 */
	public TimePickerCustomerGuider(Activity activity) {
		super(activity);
	}
	//Constructors
	 ...
	 */
	public TimePickerCustomerGuider(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 */
	public TimePickerCustomerGuider(Context context, AttributeSet attrs, int defStyle) {
